<template>
    <form class="mx-auto col-6 border border-gray-300 rounded-lg p-4 mt-5" @submit.prevent="reset">
        ...
        <div class="mb-3">
            ...
            <Input type="password" id="password" class="form-control" name="new-password" autocomplete="new-password" placeholder="Enter password" v-model="password" @paste="getErrors(null, 'password', ['required', 'minLength'])" @input="getErrors(null, 'password', ['required', 'minLength'])" required/>
            <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <Input type="password" id="confirm-password" class="form-control" name="new-password-confirm" autocomplete="new-password-confirm" placeholder="Enter password confirmation" v-model="password_confirmation" @paste="getErrors(null, 'password_confirmation', ['required', 'sameAsPassword'])" @input="getErrors(null, 'password_confirmation', ['required', 'sameAsPassword'])" required/>
            <div class="mb-3">
